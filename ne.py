...
class MusicApp:
    def __init__(self, root):
        ...
        self.settings_button = tk.Button(control_frame, text="Settings", command=self.open_settings, width=10, height=2, bg='#CCCCFF')
        ...
        self.colors = ['black', 'red', 'green', 'blue', 'yellow', 'purple', 'orange']
        for color in self.colors:
            button = tk.Button(color_frame, bg=color, width=2, height=2, command=lambda c=color: self.change_color(c))
            button.pack(pady=5)

        self.color_picker_button = tk.Button(color_frame, text="More...", command=self.pick_color, width=6, height=2)
